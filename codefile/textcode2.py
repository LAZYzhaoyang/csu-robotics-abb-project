# -*- coding: utf-8 -*-
"""
Created on Sat Mar 16 14:43:06 2019
...
#def reconizedpoint(path)
  ...
  img_morph=cv2.erode(img_morph,(6,6),img_morph,iterations=2)#腐蚀图像
  morph=cv2.dilate(img_morph,(6,6),img_morph,iterations=2)#膨胀图像
  ...
  for i in range(0,anum):
      ...
      center_x,center_y=(p1x+p3x)*10/2,(p1y+p3y)*10/2#得到中心坐标
