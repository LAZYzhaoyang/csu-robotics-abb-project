# -*- coding: utf-8 -*-
"""
Created on Tue Apr  2 14:24:04 2019
...
# -*- coding: utf-8 -*-
"""
Created on Sun Mar 17 18:18:04 2019
...
while isstart == True:
    ...
    """
    image1=cv2.imread('text_the_error_of_camera2.jpg')
    # 去畸变
    h,w = image1.shape[:2]
    ...
    cv2.imwrite('text_the_error_of_camera3.jpg',dst1)
    #image reconized
    path1='text_the_error_of_camera2.jpg'
    ...
    ret,thresh=cv2.threshold(gray,200,255,cv2.THRESH_BINARY) #阈值化处理，大于148的变为白色（0为黑色，255为白），输入灰度图
    mask=thresh#构建掩模
    ...
    for i in range(0,anum):
        ...
        if thingy1-worldy0<=0:
            ...
            dyw1=-dyw1
        #dxw1,dyw1=dyw1,dxw1
        dxw1=math.floor(dxw1)
        dyw1=math.floor(dyw1)
        if abs(dxw1)>=300 or abs(dyw1)>=300:
            continue
        hight1=0
        sendwords1=str(dxw1)+','+str(dyw1)+',0,'+str(hight1)+','+str(1)+',0/0D'
        drophight1 = 300
        drophight2=0
        thinghight=15
